...
# input archive: downloads/growdb/5986_99ID_drep_global.tar.gz
# output filelist: corpus/cluster_inputs/rabbittclust/growdb.list
#
# This builder covers the global freshwater 99% dereplicated comparison set,
# not the core 2,093 GROWdb-only MAG catalogue.
...
SLUG = "growdb"
ARCHIVE_NAME = "5986_99ID_drep_global.tar.gz"
EXPECTED_ARCHIVE_BYTES = 3_871_847_204
EXPECTED_MD5 = "2ed31a0b87c4d9ee5c86ed5aa92abe83"
EXPECTED_FASTA_COUNT = 5_986
FASTA_SUFFIXES = (
    ".fa",
    ".fasta",
    ".fna",
