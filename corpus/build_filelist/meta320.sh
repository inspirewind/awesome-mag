...
# input archive: downloads/meta320/meta320_figshare_40441679
# output filelist: corpus/cluster_inputs/rabbittclust/meta320.list
...
SLUG = "meta320"
ARCHIVE_NAME = "meta320_figshare_40441679"
EXPECTED_FASTA_COUNT = 5_810
MIN_ARCHIVE_BYTES = 3_000_000_000
FASTA_SUFFIXES = (
    ".fa",
    ".fasta",
    ".fna",
...
if archive_bytes < MIN_ARCHIVE_BYTES:
    raise SystemExit(
        f"Archive is unexpectedly small: {archive_path} has "
        f"{archive_bytes} bytes; expected at least {MIN_ARCHIVE_BYTES}"
    )
