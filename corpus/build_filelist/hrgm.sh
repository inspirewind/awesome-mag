...
# input archive: downloads/hrgm/HRGMv2_Rep_Genome.tar.gz
# output filelist: corpus/cluster_inputs/rabbittclust/hrgm.list
#
# This builder targets the HRGM2 representative genome archive, one
# representative genome per species.
...
SLUG = "hrgm"
ARCHIVE_NAME = "HRGMv2_Rep_Genome.tar.gz"
EXPECTED_FASTA_COUNT = 4_824
FASTA_SUFFIXES = (
    ".fa",
    ".fasta",
    ".fna",
